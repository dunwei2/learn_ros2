...
{
  new (message_memory) learn_interface::msg::ObjectPosition(_init);
}

void ObjectPosition_fini_function(void * message_memory)
{
  auto typed_message = static_cast<learn_interface::msg::ObjectPosition *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectPosition_message_member_array[2] = {
  {
    ...
    offsetof(learn_interface::msg::ObjectPosition, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(learn_interface::msg::ObjectPosition, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectPosition_message_members = {
  "learn_interface::msg",  // message namespace
  "ObjectPosition",  // message name
  2,  // number of fields
  sizeof(learn_interface::msg::ObjectPosition),
...
{
  return &::learn_interface::msg::rosidl_typesupport_introspection_cpp::ObjectPosition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, learn_interface, msg, ObjectPosition)() {
  return &::learn_interface::msg::rosidl_typesupport_introspection_cpp::ObjectPosition_message_type_support_handle;
}
