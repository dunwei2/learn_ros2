...
{
  learn_interface__srv__AddTwoInts_Request * msg = (learn_interface__srv__AddTwoInts_Request *)malloc(sizeof(learn_interface__srv__AddTwoInts_Request));
  if (!msg) {
    return NULL;
  }
...
learn_interface__srv__AddTwoInts_Request__Sequence__init(learn_interface__srv__AddTwoInts_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (learn_interface__srv__AddTwoInts_Request *)calloc(size, sizeof(learn_interface__srv__AddTwoInts_Request));
    if (!data) {
      return false;
    }
...
{
  learn_interface__srv__AddTwoInts_Request__Sequence * array = (learn_interface__srv__AddTwoInts_Request__Sequence *)malloc(sizeof(learn_interface__srv__AddTwoInts_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  learn_interface__srv__AddTwoInts_Response * msg = (learn_interface__srv__AddTwoInts_Response *)malloc(sizeof(learn_interface__srv__AddTwoInts_Response));
  if (!msg) {
    return NULL;
  }
...
learn_interface__srv__AddTwoInts_Response__Sequence__init(learn_interface__srv__AddTwoInts_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (learn_interface__srv__AddTwoInts_Response *)calloc(size, sizeof(learn_interface__srv__AddTwoInts_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  learn_interface__srv__AddTwoInts_Response__Sequence * array = (learn_interface__srv__AddTwoInts_Response__Sequence *)malloc(sizeof(learn_interface__srv__AddTwoInts_Response__Sequence));
  if (!array) {
    return NULL;
  }
