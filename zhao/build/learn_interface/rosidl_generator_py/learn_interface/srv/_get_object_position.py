...
class Metaclass_GetObjectPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'learn_interface.srv.GetObjectPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from learn_interface.srv import _get_object_position
...
class GetObjectPosition(metaclass=Metaclass_GetObjectPosition):
    from learn_interface.srv._get_object_position import GetObjectPosition_Request as Request
    from learn_interface.srv._get_object_position import GetObjectPosition_Response as Response
