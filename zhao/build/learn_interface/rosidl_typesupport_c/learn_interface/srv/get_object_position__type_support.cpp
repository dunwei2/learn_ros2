...
#include "learn_interface/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _GetObjectPosition_Request_type_support_symbol_names_t _GetObjectPosition_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, learn_interface, srv, GetObjectPosition_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, learn_interface, srv, GetObjectPosition_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_learn_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, learn_interface, srv, GetObjectPosition_Request)() {
  return &::learn_interface::srv::rosidl_typesupport_c::GetObjectPosition_Request_message_type_support_handle;
}
...
static const _GetObjectPosition_Response_type_support_symbol_names_t _GetObjectPosition_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, learn_interface, srv, GetObjectPosition_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, learn_interface, srv, GetObjectPosition_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_learn_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, learn_interface, srv, GetObjectPosition_Response)() {
  return &::learn_interface::srv::rosidl_typesupport_c::GetObjectPosition_Response_message_type_support_handle;
}
...
static const _GetObjectPosition_type_support_symbol_names_t _GetObjectPosition_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, learn_interface, srv, GetObjectPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, learn_interface, srv, GetObjectPosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, learn_interface, srv, GetObjectPosition)() {
  return &::learn_interface::srv::rosidl_typesupport_c::GetObjectPosition_service_type_support_handle;
}
