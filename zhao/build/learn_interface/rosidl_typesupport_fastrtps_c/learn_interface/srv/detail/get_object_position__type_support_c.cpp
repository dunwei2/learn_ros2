...
#include "learn_interface/srv/detail/get_object_position__rosidl_typesupport_fastrtps_c.h"
...
using _GetObjectPosition_Request__ros_msg_type = learn_interface__srv__GetObjectPosition_Request;
...
size_t get_serialized_size_learn_interface__srv__GetObjectPosition_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetObjectPosition_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_learn_interface__srv__GetObjectPosition_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_learn_interface
size_t max_serialized_size_learn_interface__srv__GetObjectPosition_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_learn_interface__srv__GetObjectPosition_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, learn_interface, srv, GetObjectPosition_Request)() {
...
using _GetObjectPosition_Response__ros_msg_type = learn_interface__srv__GetObjectPosition_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_learn_interface
size_t get_serialized_size_learn_interface__srv__GetObjectPosition_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetObjectPosition_Response__ros_msg_type * ros_message = static_cast<const _GetObjectPosition_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_learn_interface__srv__GetObjectPosition_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_learn_interface
size_t max_serialized_size_learn_interface__srv__GetObjectPosition_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_learn_interface__srv__GetObjectPosition_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, learn_interface, srv, GetObjectPosition_Response)() {
...
// already included above
// #include "learn_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "learn_interface/srv/get_object_position.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, learn_interface, srv, GetObjectPosition)() {
