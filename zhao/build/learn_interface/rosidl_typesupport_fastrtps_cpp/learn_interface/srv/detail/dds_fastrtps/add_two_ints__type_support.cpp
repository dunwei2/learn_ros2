...
#include "learn_interface/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const learn_interface::srv::AddTwoInts_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  learn_interface::srv::AddTwoInts_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
...
{
  auto typed_message =
    static_cast<const learn_interface::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<learn_interface::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  return &learn_interface::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, learn_interface, srv, AddTwoInts_Request)() {
  return &learn_interface::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_learn_interface
cdr_serialize(
  const learn_interface::srv::AddTwoInts_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  learn_interface::srv::AddTwoInts_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
...
{
  auto typed_message =
    static_cast<const learn_interface::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<learn_interface::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &learn_interface::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, learn_interface, srv, AddTwoInts_Response)() {
  return &learn_interface::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
{
  return &learn_interface::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, learn_interface, srv, AddTwoInts)() {
  return &learn_interface::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
