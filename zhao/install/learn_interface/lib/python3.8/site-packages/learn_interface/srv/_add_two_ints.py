...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from learn_interface.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from learn_interface.srv._add_two_ints import AddTwoInts_Request as Request
    from learn_interface.srv._add_two_ints import AddTwoInts_Response as Response
